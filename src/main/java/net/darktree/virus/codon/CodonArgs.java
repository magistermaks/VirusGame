...
public class CodonArgs {
    ...
    public static final CodonArg RANGE = register( new CodonArgRange( 7, new CodonMetaInfo( "Range", Utils.color(140, 140, 140) ) ) );
    public static final CodonArg VALUE = register( new CodonArgValue( 8, new CodonMetaInfo( "Value", Utils.color(200, 140, 140) ) ) );
